# Appde-Belleza_
Es una plataforma pensada para personas que desean mejorar su estética personal de manera fácil, rápida y adaptada a sus necesidades. La aplicación permite que los usuarios accedan a recomendaciones de productos, rutinas de cuidado personal y tips de belleza personalizados según su tipo de piel, cabello y preferencias. Además, ofrece herramientas interactivas como pruebas de diagnóstico y seguimiento de progreso para que cada usuario pueda ver sus avances y optimizar sus resultados.
...
<img width="876" height="548" alt="image" src="https://github.com/user-attachments/assets/50df91e8-df30-4bf0-875a-8400f0c0e83b" />
